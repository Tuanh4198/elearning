package io.yody.yodemy.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import io.yody.yodemy.IntegrationTest;
import io.yody.yodemy.repository.timezone.DateTimeWrapper;
import io.yody.yodemy.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM nts_date_time_wrapper where id=%d", fieldName, id);
    }

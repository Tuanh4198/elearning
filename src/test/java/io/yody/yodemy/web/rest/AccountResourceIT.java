package io.yody.yodemy.web.rest;

import static io.yody.yodemy.test.util.OAuth2TestUtil.TEST_USER_LOGIN;
import static io.yody.yodemy.test.util.OAuth2TestUtil.registerAuthenticationToken;
import static io.yody.yodemy.test.util.OAuth2TestUtil.testAuthenticationToken;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.get;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import io.yody.yodemy.IntegrationTest;
import io.yody.yodemy.security.AuthoritiesConstants;

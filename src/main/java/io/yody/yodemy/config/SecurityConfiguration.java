...
import io.yody.yodemy.security.*;
import io.yody.yodemy.security.oauth2.CustomClaimConverter;
import java.util.*;
import org.nentangso.core.security.NtsSecurityUtils;
import org.nentangso.core.security.oauth2.AudienceValidator;
import org.nentangso.core.security.oauth2.JwtGrantedAuthorityConverter;
        ...
        return authorities -> {
            ...
            authorities.forEach(authority -> {
                ...
                if (authority instanceof OidcUserAuthority) {
                    ...
                    mappedAuthorities.addAll(NtsSecurityUtils.extractAuthorityFromClaims(oidcUserAuthority.getUserInfo().getClaims()));
                }
            });

...
import io.yody.yodemy.elearning.service.CourseQueryService;
import io.yody.yodemy.elearning.service.CourseService;
...
/**
 * REST controller for managing {@link io.yody.yodemy.elearning.domain.CourseEntity}.
 */
@RestController
@RequestMapping("/api")
public class CourseResource {
     ...
     */
    @PostMapping("/courses")
    public ResponseEntity<CourseDTO> createCourse(@Valid @RequestBody CourseRequest courseRequest) throws URISyntaxException {
        try {
            log.debug("REST request to save Course : {}", courseRequest);
            if (courseRequest.getId() != null) {
                throw new BadRequestAlertException("A new course cannot already have an ID", ENTITY_NAME, "idexists");
            }
            CourseDTO result = courseService.save(courseRequest);
    ...
    public ResponseEntity<Void> assignCourse(@PathVariable(value = "id", required = true) final Long id) {
        log.debug("REST request to attend training: {}", id);
        courseService.assign(id);
    ...
    public ResponseEntity<CourseDTO> updateCourse(
        ...
        log.debug("REST request to update Course : {}, {}", id, courseRequest);
        if (courseRequest.getId() == null) {
            throw new BadRequestAlertException("Invalid id", ENTITY_NAME, "idnull");
        }
        if (!Objects.equals(id, courseRequest.getId())) {
        ...
        CourseDTO result = courseService.update(courseRequest);
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, courseRequest.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<CourseDTO> getCourse(@PathVariable Long id) {
        ...
        CourseDTO courseDTO = courseQueryService.findOne(id);

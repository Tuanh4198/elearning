...
import io.yody.yodemy.elearning.service.CategoryQueryService;
import io.yody.yodemy.elearning.service.CategoryService;
...
/**
 * REST controller for managing {@link io.yody.yodemy.elearning.domain.CategoryEntity}.
 */
@RestController
@RequestMapping("/api")
public class CategoryResource {
    ...
    public ResponseEntity<List<CategoryDTO>> getAllCategories(
        ...
        Page<CategoryDTO> page = categoryQueryService.findAll(criteria, pageable);
    ...
    public ResponseEntity<CategoryDTO> getCategory(@PathVariable Long id) {
        ...
        Optional<CategoryDTO> categoryDTO = categoryQueryService.findOne(id);

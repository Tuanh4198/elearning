...
export const TakeAnExamLimited = ({ result, exam }: { result?: IExamEmployeeResult; exam?: IExam }) => {
    ...
    <Flex w="100%" align="center" justify="center" mt="80px">
      <Flex direction="column" gap="20px" w="345px">
        ...
        <Flex direction="column" align="center" justify="center" gap="8px">
          <Text color="#1F2A37" size="20px" fw="700" ta="center">
            Bạn chưa đủ điểm và <br />
            hết số lần làm rồi 😢 <br />
            Hãy cố gắng vào bài kì thi tới nhé
          </Text>

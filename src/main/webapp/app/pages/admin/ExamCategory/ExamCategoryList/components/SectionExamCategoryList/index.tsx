...
import { SectionExamCategoryModal } from 'app/pages/admin/ExamCategory/ExamCategoryList/components/SectionExamCategoryModal';
import { useDisclosure } from '@mantine/hooks';
import { ICategory } from 'app/shared/model/category.model';
import { useMutateCategory } from 'app/pages/admin/ExamCategory/ExamCategoryList/hooks/useMutateCategory';

export const SectionExamCategoryList = () => {
